/**
 * @license wysihtml5 v0.4.0Myboka
  ...
  function _handleAttributes(oldNode, newNode, rule) {
    ...
    if (checkAttributes) {
      for (attributeName in checkAttributes) {
        ...
        if (typeof(newAttributeValue) === "string" && (typeof(oldNode.getAttribute(attributeName)) === "string" || newAttributeValue.length > 0)) {
    ...
    for (; i<classesLength; i++) {
      ...
      if (allowedClasses[currentClass] || allowedClasses[currentClass] == void 0) {
...
wysihtml5.views.View = Base.extend(
  ...
  wysihtml5.views.Composer = wysihtml5.views.View.extend(
    ...
    _create: function() {
      ...
      // Edit by Gen, MyBoka editor.
      var el = this.doc.createElement('p');
      this.doc.body.appendChild(el);
      this.doc.body.style.cursor = 'text';
      this.doc.body.onclick = function(){el.focus()};
      this.element            = el;
